...
<div id="wrapper"> 
  ...
  <section>
    <div class="container">
      <nav id="nav">
        <ul class="shadow">
          <li><a href="<?php echo base_url().'index.php/ui'?>" class="active"><strong>Profile</strong><span>about me</span></a></li>
          <li><a href="<?php echo base_url().'index.php/ui/resume'?>"><strong>Resume</strong><span>me and about me</span></a></li>
          <li><a href="#"><strong>My Achivement</strong><span>himalayas I conquer</span></a></li>
		  <li><a href="gallary.html"><strong>My Gallery</strong><span>a moment of rememberance</span></a></li>
        </ul>
      </nav>